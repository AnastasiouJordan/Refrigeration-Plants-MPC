function J = cost4(tStart, u_MV4, u, p, s, x, i)
        ...
        [~,x_response] = ode45(@(time,x) MPCFridgePlantsODEs4(p, x, u, time, output, s, i), time, x0);
        x.T4   = x_response(:,1)';
        x.Tin4 = x_response(:,4)';
...
%         % SP CONTROL
        ...
        MV_cost = p.R_Weight*sum((u_MV4(2:end) - u_MV4(1:end-1)).^2);
        %LIMIT CONTROL
